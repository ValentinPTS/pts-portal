// The 15 documents grouped by the real scheme lifecycle (see PROJECT-ANATOMY.md).
...
export const DOC_STAGES: DocStage[] = [
  ...
  { key: "4", bg: "Оценка и издаване", en: "Evaluation & issuing", docs: ["results-coded", "report", "certificate"] },
  { key: "5", bg: "Обратна връзка", en: "Feedback", docs: ["feedback"] },
];

// Every document key that has a stage (the 15 slots). Used to validate upload targets.
