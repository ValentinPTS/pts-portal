...
export const FORM_ELEMENTS: { id: string; nameEn: string; nameBg: string; category: string; bg: string; en: string }[] = [
  ...
  {
    // the Invitation §6 / Instruction §11 contacts block, rebuilt as an editable
    // transparent table (the PDF original is a flat image): names + roles in the
    // doc's green, phone/mail icons extracted hi-res from the Instruction PDF,
    // numbers + email in the doc's red. Every table tool works on it.
    id: "fe_contacts", nameEn: "Contacts (people & phones)", nameBg: "Контакти (лица и телефони)", category: "General",
    en: `<table style="width:100%;border-collapse:collapse"><tbody><tr><td style="border:1px solid transparent;padding:4px 8px;text-align:right;vertical-align:middle;width:38%"><p style="margin:0;font-family:'Sofia Sans Condensed',Arial,sans-serif;font-weight:700;color:#38761d;font-size:13pt">eng. Valentin Belovski</p><p style="margin:0;font-family:'Sofia Sans Condensed',Arial,sans-serif;font-style:italic;color:#38761d;font-size:8.5pt">PT Scheme Manager</p></td><td style="border:1px solid transparent;padding:4px 6px;text-align:center;vertical-align:middle;width:46px"><img src="/brand/ico-phone.png" alt="" style="height:30px"></td><td style="border:1px solid transparent;padding:4px 8px;vertical-align:middle;font-family:'Sofia Sans Condensed',Arial,sans-serif;font-weight:700;color:#bf1e2e;font-size:13pt">+359 89 7503980</td><td rowspan="2" style="border:1px solid transparent;padding:4px 6px;text-align:center;vertical-align:middle;width:46px"><img src="/brand/ico-mail.png" alt="" style="height:30px"></td><td rowspan="2" style="border:1px solid transparent;padding:4px 8px;vertical-align:middle;font-family:'Sofia Sans Condensed',Arial,sans-serif;font-weight:700;color:#bf1e2e;font-size:13pt">office@ptsbg.eu</td></tr><tr><td style="border:1px solid transparent;padding:4px 8px;text-align:right;vertical-align:middle"><p style="margin:0;font-family:'Sofia Sans Condensed',Arial,sans-serif;font-weight:700;color:#38761d;font-size:13pt">Tatyana Kasabova</p><p style="margin:0;font-family:'Sofia Sans Condensed',Arial,sans-serif;font-style:italic;color:#38761d;font-size:8.5pt">Data Collection and Coding Expert</p></td><td style="border:1px solid transparent;padding:4px 6px;text-align:center;vertical-align:middle"><img src="/brand/ico-phone.png" alt="" style="height:30px"></td><td style="border:1px solid transparent;padding:4px 8px;vertical-align:middle;font-family:'Sofia Sans Condensed',Arial,sans-serif;font-weight:700;color:#bf1e2e;font-size:13pt">+359 89 9301570</td></tr></tbody></table>`,
    bg: `<table style="width:100%;border-collapse:collapse"><tbody><tr><td style="border:1px solid transparent;padding:4px 8px;text-align:right;vertical-align:middle;width:38%"><p style="margin:0;font-family:'Sofia Sans Condensed',Arial,sans-serif;font-weight:700;color:#38761d;font-size:13pt">инж. Валентин Беловски</p><p style="margin:0;font-family:'Sofia Sans Condensed',Arial,sans-serif;font-style:italic;color:#38761d;font-size:8.5pt">Ръководител на изпитването за пригодност</p></td><td style="border:1px solid transparent;padding:4px 6px;text-align:center;vertical-align:middle;width:46px"><img src="/brand/ico-phone.png" alt="" style="height:30px"></td><td style="border:1px solid transparent;padding:4px 8px;vertical-align:middle;font-family:'Sofia Sans Condensed',Arial,sans-serif;font-weight:700;color:#bf1e2e;font-size:13pt">+359 89 7503980</td><td rowspan="2" style="border:1px solid transparent;padding:4px 6px;text-align:center;vertical-align:middle;width:46px"><img src="/brand/ico-mail.png" alt="" style="height:30px"></td><td rowspan="2" style="border:1px solid transparent;padding:4px 8px;vertical-align:middle;font-family:'Sofia Sans Condensed',Arial,sans-serif;font-weight:700;color:#bf1e2e;font-size:13pt">office@ptsbg.eu</td></tr><tr><td style="border:1px solid transparent;padding:4px 8px;text-align:right;vertical-align:middle"><p style="margin:0;font-family:'Sofia Sans Condensed',Arial,sans-serif;font-weight:700;color:#38761d;font-size:13pt">Татяна Касабова</p><p style="margin:0;font-family:'Sofia Sans Condensed',Arial,sans-serif;font-style:italic;color:#38761d;font-size:8.5pt">Експерт събиране и кодиране на данните</p></td><td style="border:1px solid transparent;padding:4px 6px;text-align:center;vertical-align:middle"><img src="/brand/ico-phone.png" alt="" style="height:30px"></td><td style="border:1px solid transparent;padding:4px 8px;vertical-align:middle;font-family:'Sofia Sans Condensed',Arial,sans-serif;font-weight:700;color:#bf1e2e;font-size:13pt">+359 89 9301570</td></tr></tbody></table>`,
  },
  {
